...
var parents_reviews = [
  ...
  },
  {
    ...
    name: "Kerry L.",
    num_of_stars: 5,
    text: "Without a doubt the best tutoring experience we have ever had. The tutors came completely prepared ( having reviewed the assignments or project or test material ahead of time) ",
    more_text:
      "and made the most of every minute. Communication was great and times were flexible allowing for sessions late into the evenings when necessary to accommodate sports and other school activities. We will be engaging this team of tutors for the duration of our children’s education.",
  },
  {
    Id: "04",
    reviewId: 4,
    ...
    name: "Deborah M.",
    num_of_stars: 5,
    text: "This tutoring service has been outstanding. Michael has been wonderful with communicating with us every step of the way and finding us the perfect math tutor for my daughter. Daniela is ",
    more_text:
      "an outstanding math tutor for both precalculus and now calculus. Before Daniela, my daughter was not confident in her math skills which caused a great deal of anxiety. After she started with Daniela, her confidence grew and her scores in math drastically improved. I would recommend this tutoring service and specifically Daniela to anyone who needs academic help. You won't regret it!",
  },
  {
    Id: "05",
    reviewId: 5,
